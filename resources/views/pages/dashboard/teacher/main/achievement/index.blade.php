...
@section('content-header')
  <x-layout-app-header title="Prestasi" :breadcrumbs="[['Prestasi']]" />
@endsection
              ...
              <div class="d-flex justify-content-end mb-2">
                <div class="btn-group">
                  <button type="button" class="btn btn-default" id="btn-add">
                    <i class="fas fa-plus mr-1"></i> Input Prestasi
                  </button>
...
@push('body-js-bottom')
  ...
  @vite('resources/js/pages/dashboard_teacher_main_achievement.js')
@endpush
