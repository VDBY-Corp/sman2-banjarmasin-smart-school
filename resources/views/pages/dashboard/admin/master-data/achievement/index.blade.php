@extends('layouts.app-dashboard', [
  'title' => 'Data Master » Kategori Prestasi',
])

@section('content-header')
  <x-layout-app-header title="Kategori Prestasi" :breadcrumbs="[['Master Data'], ['Prestasi'], ['Kategori']]" />
@endsection
              ...
              <div class="d-flex justify-content-end mb-2">
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" role="menu">
                    ...
                    <a class="dropdown-item" href="{{ asset('assets/files/templates/achievement-categories.xlsx') }}" target="_blank">
...
@push('body-js-bottom')
  @vite('resources/js/pages/dashboard_admin_masterdata_achievement_category.js')
@endpush
